...
public class JSFunctCalls : MonoBehaviour
{
  ...
  /// <summary>
  /// Registers the browser resize bridge that calls OC.SwitchDisplay("width,height").
  /// </summary>
  ...
  /// <summary>
  /// Routes the host's TokenReceived message to the socket component's auth receiver.
  /// </summary>
