mergeInto(LibraryManager.library, {
    ...
    // "width,height" into Unity (OC.SwitchDisplay) without depending on the iframe host.
    ...
    // Inbound auth: host posts { type:"TokenReceived", data:{cookie,socketURL,nameSpace} } to Unity.
